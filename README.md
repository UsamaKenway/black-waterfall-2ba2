...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/black-waterfall-2ba2)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/black-waterfall-2ba2
```

A live public deployment of this template is available at [https://black-waterfall-2ba2.templates.workers.dev](https://black-waterfall-2ba2.templates.workers.dev)
